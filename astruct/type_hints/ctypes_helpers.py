...
# bool array
class CBoolArray(CArray[bool, C.c_bool], Protocol):
...
# int arrays
class CByteArray(CArray[int, C.c_byte], Protocol):
...
class CIntArray(CArray[int, C.c_int], Protocol):
...
class CInt16Array(CArray[int, C.c_int16], Protocol):
...
class CInt32Array(CArray[int, C.c_int32], Protocol):
...
class CInt64Array(CArray[int, C.c_int64], Protocol):
...
class CInt8Array(CArray[int, C.c_int8], Protocol):
...
class CLongArray(CArray[int, C.c_long], Protocol):
...
class CLongLongArray(CArray[int, C.c_longlong], Protocol):
...
class CShortArray(CArray[int, C.c_short], Protocol):
...
class CSizeTArray(CArray[int, C.c_size_t], Protocol):
...
class CSSizeTArray(CArray[int, C.c_ssize_t], Protocol):
...
class CUByteArray(CArray[int, C.c_ubyte], Protocol):
...
class CUIntArray(CArray[int, C.c_uint], Protocol):
...
class CUInt16Array(CArray[int, C.c_uint16], Protocol):
...
class CUInt32Array(CArray[int, C.c_uint32], Protocol):
...
class CUInt64Array(CArray[int, C.c_uint64], Protocol):
...
class CUInt8Array(CArray[int, C.c_uint8], Protocol):
...
class CULongArray(CArray[int, C.c_ulong], Protocol):
...
class CULongLongArray(CArray[int, C.c_ulonglong], Protocol):
...
class CUShortArray(CArray[int, C.c_ushort], Protocol):
...
# float arrays
class CDoubleArray(CArray[float, C.c_double], Protocol):
...
class CFloatArray(CArray[float, C.c_float], Protocol):
...
class CLongDoubleArray(CArray[float, C.c_longdouble], Protocol):
